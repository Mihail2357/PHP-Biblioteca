            ...
            <form action="" method="POST">
                ...
                <table class="tbl-30">
                    ...
                    <tr>
                        <td>Librarian </td>
                        <td>
                            <input type="text" name="librarian_name" placeholder="librarian_name">
                        </td>
                    </tr>
...
if(isset($_POST['submit']))
{
    ...
    $stmt = $conn->prepare($sql);
    $stmt->bind_param('s', $librarian_name);
    $stmt->execute();
    $rest = $stmt->get_result();
    $count3 = mysqli_num_rows($rest);
        ...
        else
    {
        ...
        //Redirect Page to Add appointment
        header("location:".SITEURL.'admin/add-rent.php');
    }
        ...
        {
            $_SESSION['add'] = "<div class='error'>Book, Librarian or user doesn't exist!! </div>";
            header("location:".SITEURL.'admin/add-rent.php');
        }
